...
# Окно отображения истории ходов партии в нотации
class HistoryMovesWindow(QMainWindow):
    ...
    def populate_moves(self):
        ...
        # Формирование списка отформатированных ходов
        formatted_moves = []
        move_number = 1

        # Обработка ходов по парам (белые - чёрные)
        ...
        # Объединение ходов в текст с переносами строк
