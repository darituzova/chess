...
# Окно настроек приложения с выбором стиля шахматных фигур
class SettingsWindow(QMainWindow):
    def __init__(self, parent=None):
        ...
        # Загружаем сохранённый стиль (по умолчанию classic)
    ...
    # Сохранение выбранного стиля фигур в настройки приложения
    def save_settings(self):
        # Получение выбранного стиля из выпадающего списка
        style = self.pieceStyleComboBox.currentText()

        # Сохранение стиля в системные настройки и закрытие окна
